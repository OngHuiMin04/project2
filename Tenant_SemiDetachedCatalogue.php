...
<head>
    ...
    <title>Semi-Detached House Catalogue</title>
...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_SemiDetachedCatalogue.php">Semi-Detached House Catalogue</a></span>
    </nav>
    <div class="bannerup">
