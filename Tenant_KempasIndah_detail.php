...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_LocalAmenities.php">Neighbourhood Facility</a></span> &gt; <span><a href="Tenant_KempasIndah_detail.php">Taman Kempas Indah</a></span>
    </nav>
