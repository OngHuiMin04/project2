...
<section class="header">
    ...
    <input type="hidden" id="usertype" value="Guest">
    ...
    <section class="category">
        ...
        <div class="category-box">
          <div class="box" style="background-image:url(img/Bungalow_Villa.jpg)">
            <a href="Guest_BungalowVilla_Catalogue.php"><div class="hovertext">Bungalow/Villa</div></a>
          </div>
          <div class="box" style="background-image:url(img/apartment_condo_service_residence1.jpg)">
            <a href="Guest_AppartmentCondo_Catalogue.php"><div class="hovertext">Apartment/Condo/Service Residence</div></a>
          </div>
          <div class="box" style="background-image:url(img/semi_detached_house.jpg)">
            <a href="Guest_SemiDetachedCatalogue.php"><div class="hovertext">Semi-Detached House</div></a>
          </div>
          <div class="box" style="background-image:url(img/terrace_link_house.jpg)">
            <a href="Guest_TerraceLinkHouse_Catalogue.php"><div class="hovertext">Terrace/Link House</div></a>
          </div>
        </div>
      </section>
        ...
        <div class="handpicked-box">
            <div class="card">
                ...
                <div class="details">
                    ...
                    <a href="Guest_AppartmentCondo_Catalogue.php" class="button">
            ...
            <div class="card">
                ...
                <div class="details">
                    ...
                    <a href="Guest_SemiDetachedCatalogue.php" class="button">
            ...
            <div class="card">
                ...
                <div class="details">
                    ...
                    <a href="Guest_TerraceLinkHouse_Catalogue.php" class="button">
