...
function getLandlordProperties($conn, $email) {
    $sql = "SELECT p.propertyId, p.propertyName, p.address, p.price, p.bedroom, p.bathroom, p.size, p.propertyType, p.rentcategory, up.file_path 
            ...
            WHERE p.email = ? AND p.propertyType IN ('D')";
...
<section class="header">
    ...
    <nav>
        <a href="Landlord_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Landlord_TerraceLinkHouse_Catalogue.php">Terrace/Link House</a></span>
    </nav>
    <div class="bannerup">
    ...
    <?php
    $propertyTypes = [
        'D' => ['title' => 'D) Terrace/Link House', 'button_class' => 'Terrace/Link House'],
    ];
    ?>
