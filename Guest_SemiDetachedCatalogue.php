...
<section class="header">
    ...
    <nav>
        <a href="Guest_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Guest_SemiDetachedCatalogue.php">Semi-Detached House Catalogue</a></span>
    </nav>
    <div class="bannerup">
    ...
    <div class="catalogue-box">
        ...
        <div class="card">
            ...
            <div class="details">
                ...
                <a href="Guest_HomeDetails.php?propertyId=<?php echo htmlspecialchars($propertyId); ?>" class="button Semi-Detached House">
