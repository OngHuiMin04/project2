      ...
      <div class="container">
        <div class="news__inner">
          <article class="news__main">
            <img src="img/nd7.webp" class="news__main-cover news__main-cover--desktop" />
           
            <div class="news__main-content">
              <h1 class="news__main-title">How a focus on Chinese buyers 'doomed' Malaysia's Forest City</h1>
              <div class="news__main-info">
                <p class="news__main-subtitle">
                  <h3>The mega-project on artificial islands between Malaysia and Singapore has struggled to attract interest.</h3>
                </p>
                <br>
                <hr>
                <br>
                <div class="newsbox" style="text-align: center;">
                  <p><span><i>23/11/2023</i></span></p>
                  <p><span>by <b>Patrick Lee</b></span></p>
              </div>
              <hr>
              </div>
            </div>
        ...
        <p> <b>Johor Bahru, Malaysia </b>– Built along Malaysia’s southern Johor state coast, the 2,833-hectare (7,000 acres) Forest City boasts high-rise apartments overlooking Singapore aimed at Chinese nationals dreaming of a luxury home on a sunny, tropical isle.</p>
        ...
        <p>On a Malaysian public holiday afternoon in mid-November, a few hundred people were seen passing through the city’s main commercial area.
            Many of the stores were closed, with most people heading to a small adjacent water park or duty-free outlets to buy alcoholic drinks.</p>
        ...
        <p>In an effort to boost the area, Malaysian Prime Minister Anwar Ibrahim in August announced a special financial zone in Forest City with incentives including multiple entry visas, and special income tax rates.</p>
          ...
          <aside class="news__side">
            ...
            <ul class="news__side-list">
              ...
              <li class="news__side-item">
                <h3 class="news__side-item__title">
                  <a href="Landlord_NewsDetails1.php"> Residents in 1,238 low-rent Johor apartments to be evicted</a>
                </h3>
                <p class="news__side-item__description">
                    By Bernama
                </p>
