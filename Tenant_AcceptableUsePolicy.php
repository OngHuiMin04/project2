...
<head>
    ...
    <link href="Tenant_AcceptableUsePolicy.css" rel="stylesheet" type="text/css"/>
...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> <span class="separator">&gt;</span> <span> <a href="Tenant_AcceptableUsePolicy.php" class="terms-of-service">Policy of Acceptable Use</a>
    </nav>
    </section>
