      ...
      <div class="container">
        <div class="news__inner">
          <article class="news__main">
            <img src="img/nd5.jpg" class="news__main-cover news__main-cover--desktop" />
           
            <div class="news__main-content">
              <h1 class="news__main-title">Malaysia's home rental up 5.5% in 2023, says IQI's new index</h1>
              <div class="news__main-info">
                <p class="news__main-subtitle">
                  <h3>Rents across Malaysia increased by 5.5% in 2023, according to data from a newly released index.</h3>
                </p>
                <br>
                <hr>
                <br>
                <div class="newsbox" style="text-align: center;">
                  <p><span><i>11/1/2024</i></span></p>
                  <p><span>by <b>The Malaysian Reserve</b></span></p>
              </div>
              <hr>
              </div>
            </div>
          ...
          <p>Rents were now 7.4% higher than during the pandemic's worst phase, suggests the Malaysia Home Rental Index by real estate agent network IQI, a member of Juwai IQI.</p>
          <p>In the fourth quarter, it said that rents fell by 1.2% compared to the third quarter, but they still ended the year 5.5% higher than in Q4 2022.
            The index also noted that the average residential rent in Malaysia was RM1,975 per month: RM1,851 in Selangor and RM3,192 in Kuala Lumpur when examined state-wise.</p>
          <p>The rental index, which analyses over 58,000 residential rental transactions since 2018, is intended to serve as a complement to NAPIC's Malaysia House Price Index, says its promoters.</p>
          <p>Based on what it said was 'robust recovery' in the 2023 Malaysia Home Rental Index, IQI's forecast was for a continuation of growth in rental demand.</p>
          <p>Given the historical resilience of the Malaysian rental market and the post-pandemic economic rebound, it has projected a sustained rental rate increase into 2024, particularly in high-yield urban centers such as Kuala Lumpur, Johor Bahru and Iskander Puteri.</p>
          <p>"The data suggests a shift toward recovery, with the Malaysia Home Rental Index reaching its highest point in nearly three years -- since early 2020. Factors influencing these trends include supply-demand balance, seasonal variations, seasonal variations in the transaction mix, and investor activity," he said.</p>
        </div>
          </article> 
