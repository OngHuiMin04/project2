...
function getLandlordProperties($conn, $email) {
    $sql = "SELECT p.propertyId, p.propertyName, p.address, p.price, p.bedroom, p.bathroom, p.size, p.propertyType, p.rentcategory, up.file_path 
            ...
            WHERE p.email = ? AND p.propertyType IN ('C')";
...
<section class="header">
    ...
    <nav>
        <a href="Landlord_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Landlord_SemiDetachedCatalogue.php">Semi-Detached House Catalogue</a></span>
    </nav>
    <div class="bannerup">
    ...
    <?php
    $propertyTypes = [
        'C' => ['title' => 'C) Semi-Detached House', 'button_class' => 'Semi-Detached House'],
    ];
    ?>
