...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_LocalAmenities.php">Neighbourhood Facility</a></span> &gt; <span><a href="Tenant_TBI_detail.php">Taman Bukit
                Indah</a></span>
    </nav>
