      ...
      <div class="container">
        <div class="news__inner">
          <article class="news__main">
            <img src="img/nd4.jpg" class="news__main-cover news__main-cover--desktop" />
           
            <div class="news__main-content">
              <h1 class="news__main-title">Connectivity is key even as more Singaporeans eye cheaper life in Johor Bahru</h1>
              <div class="news__main-info">
                <p class="news__main-subtitle">
                  <h3>Will new rail link push more Singaporeans to opt for life in Johor Bahru as cost of living, rent in city state soars?</h3>
                </p>
                <br>
                <hr>
                <br>
                <div class="newsbox" style="text-align: center;">
                  <p><span><i>28/1/2024</i></span></p>
                  <p><span>by <b>Hadi Azmi</b></span></p>
              </div>
              <hr>
              </div>
            </div>
          ...
          <p>Despite a strong Singapore dollar and weak Malaysian ringgit, Singaporeans are not eyeing large properties in JB and are prioritising connectivity instead.</p>
          <p>Changing work cultures and the flexibility of remote working post-pandemic are making it increasingly easier for people to make the switch from Singapore to JB.</p>
          <p>Once a feared hotbed for crime, the border city of Johor Bahru that connects Singapore to Malaysia is now being sought after by citizens of the city state who are looking to escape steep rents and rising costs of living, and relishing the opportunity to stretch their dollar.</p>
          <p>"There is a spike in Singaporeans investing and moving to JB because of the rental spike in Singapore," Low, a property agent, told This Week in Asia.</p>
          <p>Since moving to JB in 2012, he said rent in Singapore had more than doubled from when he was still living in his hometown. Singapore's Urban Redevelopment Authority meanwhile reported in 2023 that rent of private residential properties increased by 29.7 per cent between 2021 and 2022 alone.</p> 
          <p>This has been compounded by the recent rise in Singapore's Goods and Services Tax from 7 per cent to 9 per cent at the start of the year, and the increasing cost of electricity, the highest since late 2022.</p>
          </div>
          </article> 
