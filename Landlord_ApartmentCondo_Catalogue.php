...
function getLandlordProperties($conn, $email) {
    $sql = "SELECT p.propertyId, p.propertyName, p.address, p.price, p.bedroom, p.bathroom, p.size, p.propertyType, p.rentcategory, up.file_path 
            ...
            WHERE p.email = ? AND p.propertyType IN ('B')";
...
<section class="header">
    ...
    <nav>
        <a href="Landlord_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Landlord_ApartmentCondo_Catalogue.php">Apartment/Condo/Service Residence</a></span>
    </nav>
    <div class="bannerup">
    ...
    <?php
    $propertyTypes = [
        'B' => ['title' => 'B) Apartment/Condo/Service Residence', 'button_class' => 'Apartment/Condo/Service Residence'],
    ];
    ?>
