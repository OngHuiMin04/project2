...
<section class="header">
    ...
    <nav>
        <a href="Landlord_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Landlord_LocalAmenities.php">Neighbourhood Facility</a></span> &gt; <span><a href="Landlord_Molek_detail.php">Taman Molek</a></span>
    </nav>
    ...
    <main>
        <section class="overview">
            <div class="content">
                <h1>Taman Molek</h1>
                <p>Taman Molek is a well-established residential and commercial area in Johor Bahru, Malaysia. Renowned for its strategic location and vibrant community, Taman Molek offers a blend of comfortable living and urban amenities. The area is home to a variety of housing options, from modern apartments to spacious landed properties, catering to diverse preferences. Taman Molek features numerous shopping centers, dining establishments, and recreational facilities, making it a popular choice for both residents and visitors.</p>
                <p>Additionally, the area is known for its excellent connectivity to major highways and public transportation, providing easy access to Johor Bahru city center and beyond. With its combination of residential charm and commercial vitality, Taman Molek is an ideal location for those seeking a balanced and convenient lifestyle.</p>
            </div>
        </section>        
        ...
        <section class="stats">
            ...
            <div class="stat-item">12<br>Medical</div>
        ...
        <section class="map-nearby">
            <div class="content">
                ...
                <div class="map-container">
                    <div id="map">
                        <iframe src="https://www.google.com/maps/d/embed?mid=1FWa4qhVFKM6s-2J0zDG6L4_yfqIFyTA&ehbc=2E312F&noprof=1" width="640" height="480"></iframe>
                    </div>
                </div>
            </div>
        </section>
