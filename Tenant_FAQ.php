...
<head>
    ...
    <link href="Tenant_FAQ.css" rel="stylesheet" type="text/css"/>
...
<section class="header">
    ...
    <nav>
    <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_FAQ.php">Frequently Asked Questions</a></span>
    </nav>
    <div class="bannerup">
    <img src="img/faq.png">
</div>
