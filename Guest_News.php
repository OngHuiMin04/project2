...
<head>
    ...
    <title>News</title>
    <link href="Guest_News.css" rel="stylesheet" type="text/css"/>
                    ...
                    <ul>
                        ...
                        <li class="dropdown">
                            ...
                            <div class="dropdown-content">
                                ...
                                <a href="Guest_ApartmentCondo_Catalogue.php">Apartment/Condo/Service Residence</a>
 ...
 <div class="mainnews">  
    <section class = "banner">
        <div class = "banner-main-content">
            ...
            <button>
                <a href = "Guest_AboutUs.php">Know More</a>
            </button>
        </div>
        ...
        <div class = "banner-sub-content">
            ...
            <div class = "hot-topic">
                ...
                <div class = "hot-topic-content">
                    ...
                    <a href = "Guest_NewsDetails1.php">Read More</a>
                </div>
            </div>
            ...
            <div class = "hot-topic">
                ...
                <div class = "hot-topic-content">
                    ...
                    <a href = "Guest_NewsDetails2.php">Read More</a>
                </div>
            </div>
            ...
            <div class = "container-bottom-left">
                <article>
                    ...
                    <div>
                        ...
                        <a href = "Guest_NewsDetails3.php">Read More</a>
                    </div>
                </article>
                ...
                <article>
                    ...
                    <div>
                        ...
                        <a href = "Guest_NewsDetails4.php">Read More</a>
                    </div>
                </article>
            </div>
        </section>
        ...
        <section class = "main-container-right">
            ...
            <article>
                ...
                <div>
                    ...
                    <a href = "Guest_NewsDetails5.php">Read More </a>
                </div>
            ...
            <article>
                ...
                <div>
                    ...
                    <a href = "Guest_NewsDetails6.php">Read More </a>
                </div>
            ...
            <article>
                ...
                <div>
                    ...
                    <a href = "Guest_NewsDetails7.php">Read More </a>
                </div>
            ...
            <article>
                ...
                <div>
                    ...
                    <a href = "Guest_NewsDetails8.php">Read More </a>
                </div>
            ...
            <article>
                ...
                <div>
                    ...
                    <a href = "Guest_NewsDetails9.php">Read More </a>
                </div>
    ...
    <section class="footer">
        ...
        <div class="policy-and-copyright">
            <div class="policy-links">
                ...
                <a href="Guest_TermsofService.php">Terms of Service</a>
