...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_BungalowVilla_Catalogue.php">Bungalow/Villa Catalogue</a></span>
    </nav>
    <div class="bannerup">
