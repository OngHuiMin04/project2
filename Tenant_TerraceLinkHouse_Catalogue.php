...
$sql = "SELECT p.propertyId, p.propertyName, p.address, p.price, p.bedroom, p.bathroom, p.size, up.file_path 
        FROM properties p
...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_TerraceLinkHouse_Catalogue.php">Terrace/Link House</a></span>
    </nav>
    <div class="bannerup">
...
<div class="catalogue-box">
    ...
    <div class="card">
        ...
        <div class="details">
            ...
            <a href="Guest_HomeDetails.php?propertyId=<?php echo htmlspecialchars($propertyId); ?>" class="button Bungalow/Villa">
                    <i class="fas fa-building"></i> Bungalow/Villa
                </a>
            </div>
        </div>
    </div>
