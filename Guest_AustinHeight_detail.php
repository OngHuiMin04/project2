...
<head>
    ...
    <title>Local Amenities Detail</title>
    <link href="Guest_Homepage.css" rel="stylesheet" type="text/css" />
    <link href="Guest_LocalAmenitiesDetail.css" rel="stylesheet" type="text/css" />
...
<section class="header">
    ...
    <nav>
        <a href="Guest_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Guest_LocalAmenities.php">Neighbourhood Facility</a></span> &gt; <span><a href="Guest_AustinHeight_detail.php">Taman Austin Height</a></span>
    </nav>

    <main>
        <section class="overview">
            <div class="content">
                <h1>Taman Austin Height</h1>
                <p>Taman Austin Heights is a prominent residential township located in Johor Bahru, Malaysia. Known for its modern amenities and strategic location, Taman Austin Heights offers a vibrant living environment with a mix of residential homes, commercial areas, and recreational facilities. The township is renowned for its well-planned infrastructure, lush green spaces, and a variety of housing options ranging from cozy apartments to spacious landed properties. Taman Austin Heights is favored by residents for its convenience, proximity to educational institutions, shopping malls, healthcare centers, and easy access to major highways, making it an ideal choice for families and individuals seeking a balanced urban lifestyle in Johor Bahru.</p>
            </div>
        </section>        
        
        <section class="stats">
            <div class="stat-item">6<br>Shopping Malls</div>
            <div class="stat-item">10<br>Food Court</div>
            <div class="stat-item">1<br>Petrol Station</div>
            <div class="stat-item">7<br>Education</div>
            <div class="stat-item">3<br>Medical</div>
        ...
        <section class="map-nearby">
            <div class="content">
                ...
                <div class="map-container">
                    <div id="map">
                        <iframe src="https://www.google.com/maps/d/u/0/embed?mid=1ucq1tX-KnVg-H9OPSdrATImixK55oXo&ehbc=2E312F&noprof=1" width="640" height="480"></iframe>
                    </div>
                </div>
            </div>
        </section>
