...
<head>
    ...
    <link href="Landlord_PrivacyPolicy.css" rel="stylesheet" type="text/css"/>
...
<section class="header">
    ...
    <nav>
        <a href="Landlord_Homepage.php"><i class="fas fa-home"></i></a> <span class="separator">&gt;</span> <span> <a href="Landlord_PrivacyPolicy.php" class="terms-of-service">Privacy Policy</a>
    </nav>
    </section>
