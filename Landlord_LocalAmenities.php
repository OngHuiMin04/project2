...
<head>
    ...
    <link href="Landlord_LocalAmenities.css" rel="stylesheet" type="text/css" />
...
<div class="bannerup">
    ...
    <div class="area-box">
        ...
        <div class="box-container">
            <a href="Landlord_AustinHeight_detail.php">
                <div class="flip-box">
        ...
        <div class="box-container">
            <a href="Landlord_TBI_detail.php">
                <div class="flip-box">
                    <div class="flip-box-inner">
        ...
        <div class="box-container">
            <a href="Landlord_Horizon_detail.php">
                <div class="flip-box">
                    <div class="flip-box-inner">
        ...
        <div class="box-container">
            <a href="Landlord_KempasIndah_detail.php">
                <div class="flip-box">
                    <div class="flip-box-inner">
        ...
        <div class="box-container">
            <a href="Landlord_Molek_detail.php">
                <div class="flip-box">
                    <div class="flip-box-inner">
        ...
        <div class="box-container">
            <a href="Landlord_MountAustin_detail.php">
                <div class="flip-box">
                    <div class="flip-box-inner">
