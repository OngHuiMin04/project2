...
<head>
    ...
    <link href="Guest_LocalAmenities.css" rel="stylesheet" type="text/css" />
    ...
    <section class="areainsider">
        ...
        <div class="area-box">
            <div class="box-container">
                <a href="Guest_AustinHeight_detail.php">
                    <div class="flip-box">
            ...
            <div class="box-container">
                <a href="Guest_Horizon_detail.php">
                    <div class="flip-box">
                        <div class="flip-box-inner">
            ...
            <div class="box-container">
                <a href="Guest_KempasIndah_detail.php">
                    <div class="flip-box">
                        <div class="flip-box-inner">
            ...
            <div class="box-container">
                <a href="Guest_MountAustin_detail.php">
                    <div class="flip-box">
                        <div class="flip-box-inner">
