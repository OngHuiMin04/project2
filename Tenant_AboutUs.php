...
<head>
    ...
    <link href="Tenant_AboutUs.css" rel="stylesheet" type="text/css"/>
...
<section class="header">
    ...
    <nav>
        <a href="Tenant_Homepage.php"><i class="fas fa-home"></i></a> &gt; <span><a href="Tenant_AboutUs.php">About Us</a></span>
    </nav>
    <div class="bannerup">
